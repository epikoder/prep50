...
export default async function ManageLayout({ url }: Request, ctx: FreshApp) {
  const pathname = ctx.url.pathname;
  const currentRoute = pathname.startsWith("/collections")
    ? "collection"
  ...
  return (
    <div
      class={"dark:bg-gray-900 dark:text-gray-100 grid grid-cols-12 h-[100vh] text-sm"}
    >
      <div class="col-span-1 p-4 h-[-webkit-fill-available]">
        <svg
          width="80"
          height="35"
          viewBox="0 0 288 96"
        ...
        <div class={"space-y-4"}>
          <div>
            <a href="/collections">
              <CollectionIcon active={currentRoute === "collection"} />
            </a>
          </div>
          <div>
            <a href="/collections">
              <ManangeIcon active={currentRoute === "manage"} />
            </a>
          </div>
          <div>
            <a href="/users">
              <UserIcon active={currentRoute === "user"} />
            </a>
          </div>
        </div>
      </div>

      <div class="col-span-11 h-[100vh]">
        <div class={"p-4 flex justify-end"}>
          <div class="dark:text-gray-300">
            Welcome {ctx.state.user?.email.split("@")[0]}
          </div>
        </div>
        {
